package br.com.franksanc.todolist.task;
...
import br.com.franksanc.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if (taskModel.getStartAt().isAfter(taskModel.getEndAt())) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body("A data de término deve ser maior do que a data de inicio");
        }
    ...
    public ResponseEntity delete(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id) {
        ...
        return ResponseEntity.ok().body("A tarefa foi deletada com sucesso");
